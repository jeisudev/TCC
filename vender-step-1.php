...
if (isset($_SESSION['nome']) && $_SESSION['nome'] != '') {
    $_SESSION['nome_prod'] = "";
    $_SESSION['comentario_prod'] = "";
    $_SESSION['qtd_prod'] = "";
    $_SESSION['valor_prod'] = "";
    $_SESSION['categ_prod'] = "";

    if (isset($_POST['btn-go'])) {
        $_SESSION['nome_prod'] = $_POST['nome_prod'];
        $_SESSION['comentario_prod'] = $_POST['comentario_prod'];
            ...
            <main>
                <form action="" method="POST">
                    ...
                    <div class="textfield">
                        ...
                        <input type="text" name="nome_prod" placeholder="Digite Aqui..." autofocus required>
                    </div>
                    <div class="textfield">
                        <label for="nome"> Descrição do produto*</label>
                        <textarea name="comentario_prod" class="textfield" cols="30" rows="7"></textarea>
                    </div>
