...
if (isset($_POST['btn_go_cadastra'])) {
    ...
    header("location: cadastro-step-4.php");
    // echo"<pre>";
    // print_r($_SESSION);
    // echo"</pre>";
}
    ...
    <div id="container">
        ...
        <main class="bg">
            <section class="login">
                ...
                <main class="main-cadastro-endereco">
                        ...
                        <ul>
                            <li>
                                <div class="textfield">
                                    ...
                                    <input type="text" name="cep" id="cep" placeholder="Digite aqui..." required
                                        autofocus value="<?= $dados['cep'] ?? '' ?>">
                                </div>
                            </li>
                            <li>
                                <div class="textfield">
                                    ...
                                    <input type="text" name="endereco" id="endereco" placeholder="Digite aqui..."
                                        autocomplete="off" value="<?= $dados['address'] ?? '' ?>">
                                </div>
                            </li>
                            <li>
                                <div class="textfield">
                                    ...
                                    <input type="text" name="bairro" id="bairro" placeholder="Digite aqui..."
                                        autocomplete="off" value="<?= $dados['district'] ?? '' ?>">
                                </div>
                            </li>
                            <li>
                                <div class="textfield">
                                    <label for="cidade"> cidade </label>
                                    <input type="text" name="cidade" id="cidade" placeholder="Digite aqui..."
                                        autocomplete="off" value="<?= $dados['city'] ?? '' ?>">
                                </div>
                            </li>
                            <li>
                                <div class="textfield">
                                    <label for="state"> estado </label>
                                    <input type="text" name="state" id="state" placeholder="Digite aqui..."
                                        autocomplete="off" value="<?= $dados['state'] ?? '' ?>">
                                </div>
                            </li>
